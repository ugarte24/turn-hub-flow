...
import { TicketCodeView } from "@/lib/ticket-code";
  ...
  return (
    <div className="text-center">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Turno <span className="font-ticket font-bold text-primary"><TicketCodeView code={t.code} /></span>
  ...
  return (
    <div className="text-center">
      ...
      <div className="mt-6 rounded-3xl border-2 border-dashed border-primary/40 bg-gradient-to-b from-primary/5 to-transparent p-6">
        ...
        <div className="mt-2 font-ticket text-6xl font-extrabold text-primary md:text-7xl"><TicketCodeView code={t.code} /></div>
  ...
  return (
    <div>
      ...
      <div className="mt-5 rounded-2xl border border-border bg-accent/40 p-5">
        ...
        <p className="font-ticket text-4xl font-extrabold text-primary"><TicketCodeView code={t.code} /></p>
